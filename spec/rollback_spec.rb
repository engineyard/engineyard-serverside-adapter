...
describe EY::Serverside::Adapter::Rollback do
  ...
  context "with valid arguments" do
    ...
    it "invokes exactly the right command" do
      command.should == "engineyard-serverside deploy rollback --app rackapp --config '{\"a\":1}' --framework-env production --instance-names localhost:chewie --instance-roles localhost:han,solo --instances localhost --stack nginx_unicorn"
    end
  end
end
