...
describe EY::Serverside::Adapter::Integrate do
  ...
  context "with valid arguments" do
    ...
    it "invokes exactly the right command" do
      command.should == "engineyard-serverside integrate --app rackapp --framework-env production --instance-names localhost:chewie --instance-roles localhost:han,solo --instances localhost --stack nginx_unicorn"
    end
  end
end
