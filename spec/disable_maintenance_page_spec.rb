...
describe EY::Serverside::Adapter::DisableMaintenancePage do
  ...
  context "with valid arguments" do
    ...
    it "invokes exactly the right command" do
      command.should == "engineyard-serverside deploy disable_maintenance_page --app rackapp --instance-names localhost:chewie --instance-roles localhost:han,solo --instances localhost"
    end
  end
end
