...
describe EY::Serverside::Adapter::EnableMaintenancePage do
  ...
  context "with valid arguments" do
    ...
    it "invokes exactly the right command" do
      command.should == "engineyard-serverside deploy enable_maintenance_page --app rackapp --instance-names localhost:chewie --instance-roles localhost:han,solo --instances localhost"
    end
  end
